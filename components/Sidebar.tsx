    ...
    <aside className="w-20 lg:w-72 bg-slate-950/50 border-r border-white/5 flex flex-col h-full transition-all">
      ...
      <div className="h-20 flex items-center justify-center lg:justify-start lg:px-10">
        <div className="flex items-center gap-3">
          ...
          <span className="hidden lg:block font-heading font-extrabold text-xl tracking-tight">
            Cloud-Drop
          </span>
        </div>
      </div>
      ...
      <div className="p-6 mt-auto space-y-4">
        ...
        <button
          onClick={onLogout}
          className="flex items-center justify-center lg:justify-start gap-4 px-4 py-3 w-full text-slate-500 hover:text-rose-400 transition-colors group"
        >
